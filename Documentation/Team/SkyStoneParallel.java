...
public class SkyStoneParallel extends SkyStoneMotors {
    ...
    public SkyStoneParallel(OpMode op, double clicks_per_inch, double clicks_per_degree, double degrees_drift) {
        super(op);
    ...
    private static final String FRONT_LEFT_MOTOR  = "front port_left";
    private static final String FRONT_RIGHT_MOTOR = "front stbd_left";
    private static final String BACK_LEFT_MOTOR   = "port_right port_left";
    private static final String BACK_RIGHT_MOTOR  = "port_right stbd_left";
